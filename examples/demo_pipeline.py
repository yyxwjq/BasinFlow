...
This script demonstrates the complete Stage 1 (Geometry & Data Core)
capability using the Au₁₀₁ cluster benchmark dataset.
...
# ---------------------------------------------------------------------------
print("=" * 62)
print("  Stage 1 — Geometry & Data Core  ·  Pipeline Demo")
print("=" * 62)
...
# ---------------------------------------------------------------------------
# 4.  Pairwise training view — auto-derived MIC labels
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 5.  Basin view — multi-event groups
# ---------------------------------------------------------------------------
...
for ev in bitem["events"]:
    print(f"      {ev.event_id}  →  product {ev.product_structure_id}")

# ---------------------------------------------------------------------------
# 6.  Collate a mini-batch (ready for model input)
# ---------------------------------------------------------------------------
...
print(f"\n{'─' * 62}")
print("  ✅  Stage 1 pipeline complete — ready for Stage 2 model training.")
print(f"{'─' * 62}")
